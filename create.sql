...
CREATE TABLE IF NOT EXISTS `mydb`.`Projekat` (
  ...
  `Clan_organizacije_jmbg` INT(13) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Trosak` (
  ...
  `Clan_organizacije_Osoba_jmbg` INT(13) NOT NULL,
  INDEX `fk_Trosak_Projekat1_idx` (`Projekat_id_projekta` ASC),
  INDEX `fk_Trosak_Clan_organizacije1_idx` (`Clan_organizacije_Osoba_jmbg` ASC),
  ...
  CONSTRAINT `fk_Trosak_Clan_organizacije1`
    FOREIGN KEY (`Clan_organizacije_Osoba_jmbg`)
    REFERENCES `mydb`.`Clan_organizacije` (`jmbg`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `mydb`.`Volontiranje` (
  `Projekat_id_projekta` INT NOT NULL,
  `Volonter_Ucesnik_na_projektu_jmbg` INT(13) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Ucestvovanje` (
  ...
  `Projekat_id_projekta` INT NOT NULL,
  `Volonter_Osoba_jmbg` INT(13) NOT NULL,
  PRIMARY KEY (`Ucesnik_Ucesnik_na_projektu_jmbg`, `Projekat_id_projekta`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Podrzava` (
  `Projekat_id_projekta` INT NOT NULL,
  `Gost_Ucesnik_na_projektu_jmbg` INT(13) NOT NULL,
